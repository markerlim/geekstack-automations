...
WATCHLIST_PATH = "gundamtcgdb/watchlist.json"
...
def check_for_new_series():
    ...
    #existing_values, file_sha = github_service.load_json_file(FILE_PATH) series.json to deprecate
...
def check_for_watchlist():
    ...
    watchlist = ["619701","619801","619901","619103","619008","619007"]
